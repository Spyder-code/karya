        ...
        <div class="flex flex-col md:flex-row lg:flex-row w-full p-4" style="background-image: url({{ asset('images') }}/vector_section_event.png); background-repeat: no-repeat;">
            <div class="w-full md:w-1/2 lg:w-1/2 bg-transparent">
                <div class="grid grid-cols-2 gap-4 p-4">
                    <a href="https://docs.google.com/forms/d/1UNFeThxEbZhBDhgAwElKQwOFFeiR3l6sIgEX7XZdC7k/viewform?edit_requested=true" target="_blank">
                    ...
                    <a href="https://drive.google.com/file/d/1NEFjtB62GBKx_UFLPcpVL6NkB_9hVFrZ/view" target="_blank">
                        <div class="border shadow-lg bg-white rounded-xl p-4 text-center transform hover:scale-105 hover:border-blue-500 motion-reduce:transform-none">
                    ...
                    <a href="https://drive.google.com/drive/u/0/mobile/folders/134pKQW6Hacxn8n53_NTKzhVpNI2Uo6mr?usp=sharing" target="_blank">
                        <div class="border shadow-lg bg-white rounded-xl p-4 text-center transform hover:scale-105 hover:border-blue-500 motion-reduce:transform-none">
                    ...
                    <a href="https://docs.google.com/forms/d/1tALZMATeYnv0GDc7FYPF4S2SxjUKRLdw_KJ4pUpxPtY/viewform?edit_requested=true" target="_blank">
                        <div class="border shadow-lg bg-white rounded-xl p-4 text-center transform hover:scale-105 hover:border-blue-500 motion-reduce:transform-none">
