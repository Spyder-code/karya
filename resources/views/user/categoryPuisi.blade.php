...
<section class="m-10 pt-16" style="font-family: 'Quicksand', sans-serif;">
    <div class="pb-5 min-h-full">
        <h4><a href="{{ route('beranda') }}">Home</a> > <a href="{{ route('user.category-puisi') }}" style="color: rgba(96, 165, 250, 100);">Puisi</a></h4>
    </div>
</section>
<section>
...
<div class="px-28">
    <div class="bg-contain bg-no-repeat" style="background-image: url({{ asset('images') }}/Group\ 7_blue.svg);">
        ...
        <div class="text-center" style="font-family: 'Quicksand', sans-serif;">
            <button class="bg-blue-200 hover:bg-blue-300 text-black py-2 px-6 rounded">Load More</button>
        </div>
    </div>
</div>
@endsection
