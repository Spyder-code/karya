...
@section('content')
    ...
    <section class="m-10 pt-16">
        ...
        <div class="relative px-0 md:px-12 lg:px-32">
            <div class="rounded-3xl p-4 sm:p-10 md:p-15 lg:p-20 bg-green-200">
            ...
            <div class="flex flex-row pt-14 justify-between" style="font-family: 'Poppins', sans-serif;">
                <div class="w-1/2 text-left">
                    @if ($prev!==null)
                    <a class="flex-auto text-xs sm:text-base md:text-base lg:text-base text-black hover:text-green-500" href="{{ route('user.baca-karya.detail',['id'=>$prev->id]) }}">
                ...
                <div class="w-1/2 text-right">
                    @if ($next!=null)
                    <a class="flex-auto text-xs sm:text-base md:text-base lg:text-base text-black hover:text-green-500" href="{{ route('user.baca-karya.detail',['id'=>$next->id]) }}">
