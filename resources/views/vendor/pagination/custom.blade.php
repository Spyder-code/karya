                ...
                @if (is_array($element))
                    ...
                    @if ($page == $paginator->currentPage())
                        <span aria-current="page">
                            <span class="mx-3 px-3 py-2 bg-blue-500 text-white hover:bg-blue-500 hover:text-white relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium rounded-lg bg-white border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                        </span>
                    @else
